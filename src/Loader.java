...
public final class Loader extends JFrame {
    ...
    private static final String CLIENT_URL = "https://www.dropbox.com/s/hqmytmk8yyxq62r/Arkitori.jar?dl=1";
    private static final String CLIENT_DIRECTORY = System.getProperty("user.home") + "/Desktop/Arkitori/";
                ...
                try {
                    ...
                    SwingWorker<Void, Void> worker = new SwingWorker<Void, Void>() {
                        ...
                        protected Void doInBackground() throws Exception {
                            ...
                            File existingClient = new File(CLIENT_DIRECTORY + "Arkitori.jar");
                            ...
                            try {
                                ...
                                out = new FileOutputStream(CLIENT_DIRECTORY + "Arkitori.jar");
                                ...
                                frame.status.setText("Error loading client...Please post a bug report at www.arkitori.com.");
