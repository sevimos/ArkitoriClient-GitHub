...
public class Model extends Animable {
	...
	public void replaceRasterizer(int i, int j) {
	...
	public void read525Model(byte abyte0[], int modelID) {
		...
		convertTextureIds(D, texTrianglesPoint1, texTrianglesPoint2, texTrianglesPoint3, x);
	}
	
	
	public void convertTextureIds(short[] textureIds, int[] texa, int[] texb, int[] texc, byte[] texture_coordinates) {
		int set = 0;
		int set2 = 0;
