...
public class Client extends ClientEngine {
    ...
    private int[] bankInvTemp = new int[752];
    private int[] bankStackTemp = new int[752];
...
if (shiftDrop && shiftIsDown){
    ...
    private void method37(int j) {
        if (Configuration.enableMovingTextures) {
            ...
            if (Rasterizer.anIntArray1480[52] >= j) {
                Background background_2 = Rasterizer.aBackgroundArray1474s[52];
                int i1 = background_2.anInt1452 * background_2.anInt1453 - 1;
                int l1 = background_2.anInt1452 * anInt945 * 2;
                byte abyte2[] = background_2.aByteArray1450;
                byte abyte5[] = aByteArray912;
            ...
            if (Rasterizer.anIntArray1480[53] >= j) {
                Background background_2 = Rasterizer.aBackgroundArray1474s[53];
                int i1 = background_2.anInt1452 * background_2.anInt1453 - 1;
                int l1 = background_2.anInt1452 * anInt945 * 2;
                byte abyte2[] = background_2.aByteArray1450;
                byte abyte5[] = aByteArray912;
            ...
            if (Rasterizer.anIntArray1480[51] >= j) {
                Background background_2 = Rasterizer.aBackgroundArray1474s[51];
                int i1 = background_2.anInt1452 * background_2.anInt1453 - 1;
                int l1 = background_2.anInt1452 * anInt945 * 2;
                byte abyte2[] = background_2.aByteArray1450;
                byte abyte5[] = aByteArray912;
    ...
    public void resetLogout() {
        ...
        loginLoaded = false;
        loginScreenState = 0;
        loginMessage1 = "Welcome to Arkitori";
    ...
    private void loadTitleScreen() {
        ...
        drawLoadingText(10, "Starting up Arkitori client");
        if (!aBoolean831) {
            drawFlames = true;
            aBoolean831 = true;
    ...
    static {
        try {
            BACKGROUND = new Sprite(new URL("https://www.dropbox.com/s/glkzewlas2jn5br/11.png?dl=1"));
            LOADING_BAR_EMPTY = new Sprite(new URL("https://dl.dropboxusercontent.com/s/b8j6nufiie0yntz/frame.png"));
    ...
    private void build3dScreenMenu() {
        ...
        for (int k = 0; k < Model.anInt1687; k++) {
            int l = (int) Model.anIntArray1688[k];
            int i1 = l & 0x7f;
            int j1 = l >> 7 & 0x7f;
            int k1 = l >> 29 & 3;
            int l1 = l >> 14 & 0x7fff;
    ...
    void startUp() {
        ...
        drawSmoothLoading(1, "www.Arkitori.com");
        ...
        try {
            ...
            drawSmoothLoading(250, "Don't forget to register on our active community forums! www.arkitori.com");
           ...
           // repackCacheIndex(2); // models
          //  repackCacheIndex(4); // anims
            ...
            drawSmoothLoading(550, "Arkitori is now loading... Please wait.");
    ...
    public boolean loginLoaded = false;
        ...
        for (int j2 = 0; j2 < i2; j2++) {
            ...
            if (child.type == 0) {
                ...
                //TODO here is it
                    ...
                    boolean hover = false;
                    //k2= current x
                    //j2= current y of node
                    int xx = class9.childX[j2] + (frameMode == ScreenMode.FIXED ? 0 : (k2 - (child.width / 5)));
                    int yy = class9.childY[j2] + (frameMode == ScreenMode.FIXED ? 0 : (child.id == 59815) ? l2 - (child.width / 2) : l2 - (child.width / 4)); //l2 - (child.width / 2)
                    //System.out.println(l2 - (child.height / 2));
                    ...
                    //TODO CLICKING THE INPUT BOX HERE
	...
	public void spin() {
		if (openInterfaceID != INTERFACE_ID || spinClick == false) {
			return;
		}
    ...
    private void method146() {
        ...
        if (Configuration.enableShiftDrop) {
            shiftDrop = true;
        }
        else
        {
    ...
    private void loadAllOrbs(int xOffset) {
        ...
        if (frameMode == ScreenMode.FIXED) {
            ...
            orbComponents2[worldHover ? 6 : 5].drawSprite(frameWidth - 135, 152);
        }
    }
