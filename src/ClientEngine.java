	...
	public void actionPerformed(ActionEvent e) {
		...
		if (cmd != null) {
			...
			if (cmd.equalsIgnoreCase("Forums")) {
				Client.instance.launchURL("www.arkitori.com/");
			} else if (cmd.equalsIgnoreCase("Vote")) {
				Client.instance.launchURL("http://www.arkitori.everythingrs.com/services/vote");
			} else if (cmd.equalsIgnoreCase("Store")) {
				Client.instance.launchURL("http://www.arkitori.everythingrs.com/services/store");
