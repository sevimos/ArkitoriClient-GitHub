...
final class ObjectManager {
	...
	// int l21 = k15 > 0 ? (l9 * 256) / k15 : (l9 * 256) / 60;
			...
			for (int l6 = -5; l6 < anInt146 + 5; l6++) {
				for (int i8 = 0; i8 < anInt147; i8++) {
					...
					if (k9 >= 0 && k9 < anInt146) {
						...
						if (l12 > 0) {
							FloorUnderlayDefinition flo = FloorUnderlayDefinition.cache[l12 - 1];
					...
					if (i13 >= 0 && i13 < anInt146) {
						...
						if (i14 > 0) {
							FloorUnderlayDefinition flo_1 = FloorUnderlayDefinition.cache[i14 - 1];
							...
							if (l18 > 0 || i19 > 0) {
								...
								if (l > 0) {
									...
									if (l18 == 0 && aByteArrayArrayArray136[l][l6][k17] != 0)
										flag = false;
									if (i19 > 0 && !FloorOverlayDefinition.cache[i19 - 1].aBoolean393)
										flag = false;
								...
								if (i19 == 0) {
									...
									FloorOverlayDefinition flo_2 = FloorOverlayDefinition.cache[i19 - 1];
									...
									if (i23 >= 0) {
										...
										k23 = Rasterizer.getOverallColour(i23);
										j23 = -1;
									...
									if(flo_2.rgb2 != -1) {
										final int minimapColor = method177(flo_2.anInt394, flo_2.anInt395, flo_2.anInt396);
										k23 = Rasterizer.hslToRgb[method185(minimapColor, 96)];
									}
			...
			if (k >= 0 && k < 104 && i >= 0 && i < 104) {
				...
				do {
					...
					if (absX >= 3367 && absX <= 3370 && absY >= 9637 && absY <= 9643 && absZ == 1) {
						aByteArrayArrayArray130[l][k][i] = 100; // 103 - 16 =
																// Orange/brown
						aByteArrayArrayArray136[l][k][i] = 0; // tile shape
					}
					/**
					 * Free for all 1v1 to multi boundary
					 */
					if (absX >= 3340 && absX <= 3340 && absY >= 4760 && absY <= 4851 && absZ == 0) {
						aByteArrayArrayArray130[l][k][i] = 44; // 44 = Gray
						aByteArrayArrayArray136[l][k][i] = 0; // tile shape
					}
					if (l1 <= 49) {
