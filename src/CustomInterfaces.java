...
public class CustomInterfaces extends RSInterface {
	...
	private static void jewelryEnchating(TextDrawingArea[] mayhem) {
	...
	public static void settings(TextDrawingArea[] tda) {
		...
		addText(28506, "Customize Arkitori to your likings.", tda, 1, 0xFF981F, true, true);
		...
		for (int i = 0; i < 21 * 5; i += 5) {
			...
			x *= 113 + 30;
			y *= 34 + 5;
			addHoverButton(28551 + i, 515, 113, 34, "::shiftDrop", -1, 28551 + (i + 1), 1);
	...
	public static void mysteryBoxSpin(TextDrawingArea[] tda) {
		...
		addButton(47003, 526, "Close");
		addButton(47004, 524, "Spin!");
		...
		scroll.width = 474;
		itemGroup(47101, 1750, 1, 13, 10, false, true);
	...
	public static void questTab(TextDrawingArea tda[]) {
		...
		addText(29406, "www.Arkitori.com", tda, 0, 0xF7AA25, true, true);
	...
	public static void reportAbuse(TextDrawingArea[] daniel) {
		...
		String[] rules = { 
			...
			"Arkitori staff impersonation", "Account sharing/trading", "Macroing", "Multiple logging in",
	...
	**/
	...
	public static void fireColor(TextDrawingArea[] Mayhem) {
		...
		addText(49756, "By paying 10 Arkitori Credits you can change all fire colors.", 0xff9933, true, true, -1, Mayhem, 0);
		...
		addText(49760, "Daniel's Clan: Arkitori", 0xff9933, true, true, -1, Mayhem, 0);
	...
	public static void starter(TextDrawingArea[] daniel) {
		...
		addSprite(51751, 431);
		addText(51752, "Arkitori Account Setup", 0xff9933, true, true, 52, daniel, 2);
	...
	*/
	...
	public static void loyaltyShop(TextDrawingArea[] tda) {
		...
		addSprite(id + 6, 407);
		addText(id + 7, "Arkitori Credits", tda, 0, 0xe6be78, false, true);
		addText(id + 8, "Welcome to the Arkitori title shop.", tda, 0, 0xe6be78, false, true);
	...
	public static void bankSettings(TextDrawingArea[] Mayhem) {
		...
		addSprite(32501, 368);
		addText(32502, "Arkitori Bank Settings", 0xff9933, true, true, -1, Mayhem, 2);
	...
	*/
	...
	public static void friendsTab(TextDrawingArea[] tda) {
		...
		addText(5070, "   Arkitori", tda, 0, 0xff9933, false, true);
	...
	public static void ignoreTab(TextDrawingArea[] tda) {
		...
		addText(5720, "   Arkitori", tda, 0, 0xff9933, false, true);
	...
	public static void mysteryBox(TextDrawingArea[] daniel) {
		...
		addHoverButton(17004, 258, 146, 37, "Bet Arkitori Credits", -1, 17005, 1);
		addHoveredButton(17005, 259, 146, 37, 9454);
		addText(17006, "</col>Arkitori Credits: @gre@1,000", daniel, 0, 0xF7AA25, true, true);
		...
		addText(17008, "Mystery Box is a gambling minigame where you can bet 1 Arkitori Credit.", daniel, 0, 0xF7AA25, true, true);
		...
		addHoverText(17011, "Visit online store", "@red@Donate to Arkitori!", daniel, 0, 0xF7AA25, false, true, 168);
	...
	public static void creditsTab(TextDrawingArea[] daniel) {
		...
		addSprite(52501, 38);
		addText(52502, "Arkitori Shops", 0xff9933, true, true, -1, daniel, 2);
		addSprite(52503, 55);
		addText(52504, "Current Arkitori Credits:", 0xff9933, true, true, -1, daniel, 0);
		addHoverText(52505, "Visit online store", "@red@Donate to Arkitori!", daniel, 0, 0xF7AA25, true, true, 168);
		addSprite(52506, 56);
		/*tab.totalChildren(9);
	...
	public static void bank(TextDrawingArea[] wid) {
		...
		addContainer(5382, 109, 8, 94, new String[] { "Withdraw-1", "Withdraw-5", "Withdraw-10", "Withdraw-All", "Withdraw-X", null, "Withdraw-All but one" });
		...
		addText(id + 55, "750", wid, 0, 0xFE9624, true);
		...
		interfaceCache[5382].scrollMax=5000;
        interfaceCache[5385].scrollMax=5000;
	...
	public static void equipmentTab(TextDrawingArea[] Mayhem) {
		...
		setBounds(15201, 9, 210, 0, Interface);
        setBounds(15202, 9, 210, 1, Interface);
        setBounds(15204, 99, 210, 2, Interface);
        setBounds(15205, 99, 210, 3, Interface);
        setBounds(15207, 54, 210, 4, Interface);
        setBounds(15208, 54, 210, 5, Interface);
        setBounds(15310, 144, 210, 6, Interface);
        setBounds(15311, 144, 210, 7, Interface);
	}
	...
	public static void prayerTab(TextDrawingArea[] tda) {
		...
		int[] ID1 = { 18020, 18021, 18022, 18023, 18024, 18025, 18026, 18027,
		...
		int[] X = { 8, 44, 80, 114, 150, 8, 44, 80, 116, 152, 8, 42, 78, 116,
				152, 8, 44, 80, 116, 150, 6, 44, 80, 116, 150, 6, 44, 80 };
		int[] Y = { 6, 6, 6, 4, 4, 42, 42, 42, 42, 42, 79, 76, 76, 78, 78, 114,
				114, 114, 114, 112, 148, 150, 150, 150, 148, 184, 184, 184 };
		...
		int[] hoverX = { 12, 8, 20, 12, 24, 2, 2, 6, 6, 50, 6, 6, 10, 6, 6, 5,
				5, 5, 5, 5, 18, 28, 28, 50, 1, 1, 1, 1 };
		int[] hoverY = { 42, 42, 42, 42, 42, 80, 80, 80, 80, 80, 118, 118, 118,
				118, 118, 150, 150, 150, 150, 150, 105, 80, 65, 65, 65, 110, 110, 110 };
		String[] hoverStrings = {
		...
		int ID2[] = { 5609, 5610, 5611, 5612, 5613, 5614, 5615, 5616, 5617,
				...
				18013, 18014, 18015, 18016, 18017, 18018, 18019, 5651, 687 };
		int X2[] = { 6, 42, 78, 6, 42, 78, 114, 150, 6, 114, 150, 6, 42, 78,
				...
				81, 150, 153, 6, 9, 150, 157, 6, 8, 43, 46, 78, 81, 65, 14 };
		int Y2[] = { 4, 4, 4, 40, 40, 40, 40, 40, 76, 76, 76, 112, 112, 112,
				...
				112, 116, 148, 151, 148, 151, 184, 194, 184, 190, 186, 190, 242, 244 };
		...
		addPrayer(18014, 0, 608, 64, 7, "Piety");
		addPrayer(18016, 0, 609, 72, 9, "Rigour");
		addPrayer(18018, 0, 610, 76, 10, "Augury");
	...
	private static void addPrayer(int i, int j, int k, int l, int m, String string) {
		// TODO Auto-generated method stub
		
	}

	private static void addPrayerHover(int i, int j, int i2, String string) {
		// TODO Auto-generated method stub
		
	}

	private static void addOldPrayer(int i, String string) {
		// TODO Auto-generated method stub
