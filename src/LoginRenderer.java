...
public class LoginRenderer {
	...
	public void displayLoginScreen() {
		...
		if (client.loginScreenState == 0) {
			...
			if (client.mouseInRegion(centerX, centerY + 57, centerX + 72, centerY + 79)) {// Login Hover
				//Client.cacheSprite[7].drawSprite(centerX, centerY + 56);
			}
			if (client.mouseInRegion(centerX - 121, centerY - 72, centerX + 143, centerY - 48)) {// User Hover
				//Client.cacheSprite[8].drawSprite(centerX - 121, centerY - 72);
			}
			if (client.mouseInRegion(centerX - 121, centerY - 21, centerX + 143, centerY + 2)) {// Password Hover
				//Client.cacheSprite[8].drawSprite(centerX - 121, centerY - 21);
			}
			if (client.mouseInRegion(centerX - 28, centerY + 2, centerX - 31, centerY + 19)) {// Remember Me Hover
				Client.cacheSprite[9].drawSprite(centerX - 38, centerY);
			}	
				Client.cacheSprite[Client.rememberMe ? 10 : 9].drawSprite(centerX - 38, centerY+2);
			...
			Client.smallText.method389(true, centerX-26, 0xB0AFAB, "Client version " + ClientConstants.CLIENT_VERSION, centerY + 105);
			...
			Client.smallText.method389(true, centerX - 121, 0xB0AFAB, TextClass.capitalize(Client.myUsername) + ((client.loginScreenCursorPos == 0) & (Client.loopCycle % 40 < 20) ? "|" : ""), centerY - 56);// Username
																																																				// field
			...
			if (client.mouseInRegion(centerX - 138, centerY - 37, centerX - 112, centerY - 11)) {
				...
				Client.smallText.method389(true, centerX - 121, 0xB0AFAB, TextClass.passwordAsterisks(Client.myPassword) + ((client.loginScreenCursorPos == 1) & (Client.loopCycle % 40 < 20) ? "|" : ""), centerY - 6);// Password
			}																																																		// field
	...
	public void processLoginScreen() {
		...
		if (client.loginScreenState == 0) {
			...
			if (client.clickMode3 == 1 && client.clickInRegion(centerX + 40, centerY + 7, centerX + 127, centerY + 17)) {// Account Recovery
				client.launchURL("http://www.arkitori.com");
			}		
			...
			if (client.clickMode3 == 1 && client.clickInRegion(centerX - 38, centerY + 2, centerX - 21, centerY + 19)) {
	...
	private String[] announcements = { 
		"Welcome to Arkitori!", 
		"Developed by Sevimos.", 
		"Vote every 12 hours for great rewards!", 
		"Want to support Arkitori? Check out our online store @ http://www.arkitori.everythingrs.com/services/store"
	};
